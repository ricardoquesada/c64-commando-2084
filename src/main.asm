...
SPRITES_LO_X03 = $0421
SPRITES_LO_X04 = $0422
SPRITES_POS_Y00 = $042D
SPRITES_POS_Y01 = $042E
SPRITES_POS_Y03 = $0431
SPRITES_POS_Y04 = $0432
a043D = $043D
a043E = $043E
a0441 = $0441
a0442 = $0442
...
SPRITES_COLOR03 = $0451
SPRITES_COLOR04 = $0452
...
s0C6F   LDA SPRITES_LO_X04
        AND #$0F     ;#%00001111
        BNE b0C7B
        LDA #$00     ;#%00000000
        STA SPRITES_DELTA_X04
b0C7B   LDA SPRITES_POS_Y04
        AND #$0F     ;#%00001111
        BNE b0C87
        LDA #$00     ;#%00000000
        STA SPRITES_DELTA_Y04
...
_L00    LDA #$48     ;Sprite Y position
        STA SPRITES_POS_Y04,X
        LDA _MS_SPRITES_LO_X04,X
        STA SPRITES_LO_X04,X
        LDA _MS_SPRITES_PTR04,X
        STA SPRITES_PTR04,X
        LDA _MS_SPRITES_HI_X04,X
        STA SPRITES_HI_X04,X
        LDA #$00     ;#%00000000
        STA SPRITES_DELTA_X04,X
        STA SPRITES_DELTA_Y04,X
        LDA #$10     ;#%00010000
        STA a0492,X
        LDA #$08     ;orange
        STA SPRITES_COLOR04,X
        LDA #$00     ;#%00000000
        STA a0442,X
        INX
...
b1011   LDA a0492,Y
        ...
        BEQ b106E
        LDA SPRITES_HI_X00
        CMP SPRITES_HI_X04,Y
        BNE b106E
        LDA SPRITES_LO_X00
        CLC
        ADC #$04     ;#%00000100
        CMP SPRITES_LO_X04,Y
        BCC b106E
        LDA SPRITES_LO_X00
        SEC
        SBC #$04     ;#%00000100
...
b1F28   TYA
        STA f04A1,X
        LDA #$56     ;#%01010110
        STA SPRITES_LO_X04,Y
        LDA #$64     ;#%01100100
        STA SPRITES_POS_Y04,Y
        LDA #$F2     ;#%11110010
        STA SPRITES_PTR04,Y
        LDA #$08     ;orange
        STA SPRITES_COLOR04,Y
        LDA #$FF     ;#%11111111
        STA SPRITES_HI_X04,Y
        LDA #$FF     ;#%11111111
        STA SPRITES_DELTA_X04,Y
        LDA #$00     ;#%00000000
        STA SPRITES_DELTA_Y04,Y
        STA f04B7,Y
        STA a0442,Y
        LDA #$24     ;#%00100100
        STA a0492,Y
...
s24B3   LDX #$00     ;#%00000000
        STX a04F4
b24B8   LDA SPRITES_POS_Y04,X
        CMP #$1E     ;#%00011110
        BCC b24CF
        CMP #$C2     ;#%11000010
        BCS b24CF
        LDA SPRITES_LO_X04,X
        CMP #$5B     ;#%01011011
        BCC b24D2
        LDA SPRITES_HI_X04,X
        BEQ b24D2
b24CF   JSR s358E
b24D2   LDA a0492,X
        ASL A
...
b2633   LDA SPRITES_LO_X04,X
        STA SPRITES_LO_X04,Y
        LDA SPRITES_POS_Y04,X
        CLC
        ADC #$10     ;#%00010000
        STA SPRITES_POS_Y04,Y
        LDA #$05     ;#%00000101
...
s26DD   INC f04B7,X
        ...
        AND #$0F     ;#%00001111
        BNE b26F3
        INC SPRITES_POS_Y04,X
        LDA SPRITES_POS_Y04,X
        STA SPRITES_POS_Y04,Y
b26F3   CMP #$10     ;#%00010000
        BNE b2700
        DEC SPRITES_POS_Y04,X
        LDA SPRITES_POS_Y04,X
        STA SPRITES_POS_Y04,Y
b2700   RTS
...
b2754   LDA SPRITES_POS_Y00
        CMP SPRITES_POS_Y04,X
        BCC b2753
        LDY #$00     ;#%00000000
b275E   LDA a0492,Y
        BEQ b2769
...
s28A3   LDA SPRITES_LO_X04,X
        CLC
        ADC SPRITES_DELTA_X04,X
        CLC
        ADC SPRITES_DELTA_X04,X
        CLC
        ADC SPRITES_DELTA_X04,X
...
s2A78   LDA SPRITES_HI_X00
        CMP SPRITES_HI_X04,X
        BNE b2AC7
        LDA SPRITES_LO_X00
        CLC
        ADC #$0F     ;#%00001111
        CMP SPRITES_LO_X04,X
        BCC b2AC7
        LDA SPRITES_LO_X00
        SEC
        SBC #$0F     ;#%00001111
...
b2C46   LDA SPRITES_HI_X00
        ...
        BNE b2C97
        LDA #$FF     ;#%11111111
b2C97   STA SPRITES_DELTA_X04,Y
        LDA a00FC,b
        STA SPRITES_DELTA_Y04,Y
        LDA SPRITES_DELTA_Y04,Y
        SEC
        SBC #$02     ;#%00000010
        STA SPRITES_DELTA_Y04,Y
...
b3276   LDA #$04     ;#%00000100
        ...
        LDA SPRITES_LO_X00
        SEC
        SBC SPRITES_LO_X04,X
        BPL j3289
        LDA #$0C     ;#%00001100
        STA a00FB,b
j3289   LDA SPRITES_POS_Y00
        SEC
        SBC SPRITES_POS_Y04,X
        BPL b329B
        LSR a00FB,b
...
b33E5   LDA SPRITES_HI_X04,X
        CMP SPRITES_HI_X00
        BEQ b33F2
        BCS b3450
        JMP j341C

b33F2   LDA SPRITES_LO_X04,X
        CLC
        ADC #$1E     ;#%00011110
        CMP SPRITES_LO_X00
        BCC j341C
...
j34E1   STX a00FB,b
        ...
        LDA SPRITES_LO_X04,X
        CLC
        ADC SPRITES_LO_X04,Y
        STA SPRITES_LO_X04,Y
        LDA SPRITES_POS_Y04,X
        CLC
        ADC SPRITES_POS_Y04,Y
        STA SPRITES_POS_Y04,Y
        LDA SPRITES_HI_X04,X
        STA SPRITES_HI_X04,Y
        LDA #$90     ;bullet frame
...
_L00    LDA a0491
        ...
        STA SPRITES_HI_X03
        LDA #$00     ;#%00000000
        STA SPRITES_DELTA_X03
        LDA #$FE     ;#%11111110
        STA SPRITES_DELTA_Y03
...
b3D98   PLA
        ...
        LDA SPRITES_POS_Y00,X
        CLC
        ADC SPRITES_DELTA_Y00,X
        SEC
        SBC V_SCROLL_DELTA
        STA SPRITES_POS_Y00,X
b3DAA   INX
        CPX #$10     ;#%00010000
        BNE b3D74
        RTS
...
b3EF6   LDX #$00     ;#%00000000
        STX a00D7,b
b3EFB   LDY f004C,b,X
        LDA SPRITES_POS_Y00,Y
        LDY f004B,b,X
        CMP SPRITES_POS_Y00,Y
        BCS b3F19
        LDY f004B,b,X
        LDA f004C,b,X
        STA f004B,b,X
